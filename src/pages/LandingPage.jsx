...
export function LandingPage() {
  ...
  return (
    <div>
      {loading ? <p className="w-[100%] h-[100vh] justify-center flex flex-col items-center loaderContainer landingpageLoader">{<img alt="Logo" className="landingloader mb-[-1rem]" src={logo1}/>}</p>
        : <div>
          <Topnav />
