...
export function ClothesPage() {
  ...
  // const topRef = collection(db, "Top-Cloths");
    ...
    <div>
      ...
      <div
              ...
              onClick={() => {
                ...
                navigate("/ThriftNg/Clothes/Women-Clothes")
              }}
            >
            ...
            <div
              ...
              onClick={() => {
                ...
                navigate("/ThriftNg/Clothes/Men-Clothes")
              }}
            >
      ...
      <p   onClick={() => {
                setProducts("Cloths");
navigate("/ThriftNg/Clothes/All-Clothes")
              }}>See All</p>
