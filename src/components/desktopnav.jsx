...
export function DesktopNav() {
  ...
  return (
      <div className="flex justify-around z-10 w-[100%] desktopnav">
        {/* HOME ICON */}
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              <path
                ...
                fill={window.location.pathname === "/" ? "#ffffff" : "#000000"}
              ></path>{" "}
            </g>
          </svg>
          <p className = {window.location.pathname === "/" ? "font-bold text-[#ffffff] text-[10px] ml-[0.5rem]" : "text-[#000000] text-[10px] ml-[0.5rem]"}>Explore</p>
        </div>
       </NavLink>
       ...
       <div className="flex flex-col mx-[3rem] items-center justify-center">
       <svg
          width="30px"
          height="30px"
          viewBox="0 0 24 24"
        ...
        >
          ...
          <g id="SVGRepo_iconCarrier">
            ...
            <path
              ...
              fill={window.location.pathname === "/saved" ? "#ffffff" : "#000000"}
            ></path>{" "}
          </g>
        </svg>
        <p className = {window.location.pathname === "/saved" ? " font-bold text-[#ffffff] text-[10px]" : "text-[#000000] text-[10px]"}>Saved</p>
       </div>
       </NavLink>
       ...
       <div className="flex flex-col items-center justify-center">
       <svg
          fill={window.location.pathname === "/sell" ? "#ffffff" : "#000000"}
          version="1.1"
          id="Layer_1"
          width="30px"
          height="30px"
        ...
        <p className = {window.location.pathname === "/sell" ? "font-bold text-[#ffffff] text-[10px]" : "text-[#000000] text-[10px]"}>Sell</p>
       </div>
       </NavLink>
        ...
        <div className="flex flex-col items-center mx-[3rem] justify-center">
        <svg
          viewBox="0 0 24 24"
          fill="none"
          width="30px"
            ...
            <g id="style=fill">
              ...
              <g id="profile">
                ...
                <path
                  ...
                  fill={window.location.pathname === "/profile" ? "#ffffff" : "#000000"}
                ></path>{" "}
                <path
                  id="rec (Stroke)"
                  fill-rule="evenodd"
        ...
        <p className = {window.location.pathname === "/profile" ? " font-bold text-[#ffffff] text-[10px]" : "text-[#000000] text-[10px]"}>Profile</p>
        </div>
        </NavLink>
      </div>
  );
