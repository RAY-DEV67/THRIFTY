...
export function Profile() {
 ...
 <p>LOGO</p>
         <div className="flex items-center">
           <p className="mr-[0.5rem]">Hello {user?.displayName}</p>
          ...
          <div className="flex flex-wrap justify-center items-center">
            ...
            {/* ///////////// MAKE MONEY //////////// */}
            <div className="profile-details text-center py-[0.5rem] w-[43%] mt-[1rem] mx-[0.5rem] cursor-pointer rounded-[20px] flex justify-center items-center">
...
{/* ///////////////////// NOTIFICATIONS ////////////////////// */}
            ...
            <Link to="/Notifications" className="profile-details text-center py-[0.5rem] w-[43%] my-[1rem] mx-[0.5rem] cursor-pointer rounded-[20px] flex justify-center items-center">
            <p>Notifications</p>
...
{/* //////////////////////// CONTACT ///////////////////// */}
          ...
          <p  className="create-ad text-center py-[0.5rem] w-[80%] mx-[0.5rem] cursor-pointer rounded-[20px] flex justify-center items-center">Learn how to create an effective ad</p>
          </div>

        <div className="flex flex-col items-center">
        <button onClick={SignUserOut} className="profile-details mt-[2rem] p-[0.5rem]">
            Sign Out
          </button>
        </div>
        </div>
