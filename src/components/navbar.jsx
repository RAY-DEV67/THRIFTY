...
export function NavBar() {
  ...
  return (
      <div className="flex justify-around z-10 w-[100%] fixed bottom-0 nav py-4">
          ...
          >
            ...
            <g id="SVGRepo_iconCarrier">
              ...
              <path
                ...
                fill={window.location.pathname === "/" ? "#00CC00" : "#000000"}
              ></path>{" "}
            </g>
          </svg>
          <p className = {window.location.pathname === "/" ? "font-bold text-[#00CC00] text-[10px] ml-[0.5rem]" : "text-[#000000] text-[10px] ml-[0.5rem]"}>Explore</p>
        </div>
       </NavLink>
        ...
        >
          ...
          <g id="SVGRepo_iconCarrier">
            ...
            <path
              ...
              fill={window.location.pathname === "/saved" ? "#00CC00" : "#000000"}
            ></path>{" "}
          </g>
        </svg>
        <p className = {window.location.pathname === "/saved" ? " font-bold text-[#00CC00] text-[10px]" : "text-[#000000] text-[10px]"}>Saved</p>
       </div>
       </NavLink>
       ...
       <div className="flex flex-col items-center justify-center">
       <svg
          fill={window.location.pathname === "/sell" ? "#00CC00" : "#000000"}
          version="1.1"
          id="Layer_1"
          width="20px"
          height="20px"
        ...
        <p className = {window.location.pathname === "/sell" ? "font-bold text-[#00CC00] text-[10px]" : "text-[#000000] text-[10px]"}>Sell</p>
       </div>
       </NavLink>
            ...
            <g id="style=fill">
              ...
              <g id="profile">
                ...
                <path
                  ...
                  fill={window.location.pathname === "/profile" ? "#00CC00" : "#000000"}
                ></path>{" "}
                <path
                  id="rec (Stroke)"
                  fill-rule="evenodd"
        ...
        <p className = {window.location.pathname === "/profile" ? " font-bold text-[#00CC00] text-[10px]" : "text-[#000000] text-[10px]"}>Profile</p>
        </div>
        </NavLink>
      </div>
  );
